...
<div class="modal fade" id="modNuevoCli" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formClientes" action="<?php echo e(route('clientes.store')); ?>" method="POST">
...
<?php /**PATH C:\xampp\htdocs\administrador\resources\views/modCrearClient.blade.php ENDPATH**/ ?>