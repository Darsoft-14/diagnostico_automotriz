    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="<?php echo e(route('vehiculos.store')); ?>" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\administrador\resources\views/modCrearVehiculo.blade.php ENDPATH**/ ?>