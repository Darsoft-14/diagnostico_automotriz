...
<?php $__env->startSection('js'); ?>
    <script>
        prompter();
        function prompter() {
            var reply = prompt("Digita el codigo de acceso", "");
            if(reply==undefined)
            {
                var win = window.open("http://127.0.0.1:8000/");
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'register'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\administrador\vendor\jeroennoten\laravel-adminlte\src/../resources/views/auth/register.blade.php ENDPATH**/ ?>