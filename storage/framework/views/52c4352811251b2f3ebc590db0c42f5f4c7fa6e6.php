...
<html lang="es">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('favicons/STALogo3.ico')); ?>">
  ...
  <body>
    ...
    <div class="container border border-dark rounded-1 mt-2" style="background-color: rgb(255, 255, 255);width:75%;">
        ...
        <form id="formServicios" action="<?php echo e(route('tomaServicios.store')); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <div class="card border-none text-center mt-1">
                        ...
                        <label for="fecha" id="numServicio" class="col-form-label col-form-label-sm fs-5" style="color:rgb(255,0,0);">
                            <b><?php echo e($datos->num_servicio); ?></b>
                        </label>
                        <input type="date" class="form-control form-control-sm text-center" value=<?php echo e($datos->fecha); ?> id="fecha" name="fecha">
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="placa" name="placa" placeholder="placa" value=<?php echo e($datos->placa); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-text"><small>Marca:</small></div>
                            <input type="text" class="form-control form-control-sm" id="marca" name="marca" placeholder="Marca" value=<?php echo e($datos->marca); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="input-group">
                            <div class="input-group-text"><small>Propietario:</small></div>
                            <input type="text" class="form-control form-control-sm" id="propietario" name="propietario" placeholder="Propietario" value=<?php echo e($datos->nombre); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-sm-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="cedula" name="cedula" placeholder="Cedula" value=<?php echo e($datos->cedula); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="input-group">
                            <div class="input-group-text"><small>Dir:</small></div>
                            <input type="text" class="form-control form-control-sm" id="direccion" name="direccion" placeholder="Dirección" value=<?php echo e($datos->direccion); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-text"><small>Cel:</small></div>
                            <input type="text" class="form-control form-control-sm" id="celular" name="celular" placeholder="Celular" value=<?php echo e($datos->celular); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="input-group">
                            <div class="input-group-text"><small>@:</small></div>
                            <input type="text" class="form-control form-control-sm" id="correo" name="correo" placeholder="E-mail" value=<?php echo e($datos->email); ?> style="background-color: rgb(255, 255, 255)" disabled>
                        </div>
                    </div>
                </div>
                <br>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" method="POST" action="<?php echo e(route('vehiculos.store')); ?>" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\administrador\resources\views/nuevoServicioEdit.blade.php ENDPATH**/ ?>