...
<head>
    ...
    <title>Servicio_{{$serv}}_PDF</title>
    <style>
                ...
                <tr>
                    ...
                    <td width="13%">
                        <table id="tabla2">
                            ...
                            <tr>
                                <td class="tdh"> <b>{{$datos['num_servicio']}}</b></td>
                            </tr>
                            <tr>
                                <td class="tdf">{{$fecha}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<br><br>
                ...
                <table id="tservicios">
                    ...
                    <tbody>
                        ...
                        @endfor
                        <tr>
                            {{--  <th colspan="3">FIRMA DE CONFORMIDAD</th>  --}}
                            <th colspan="4">
                                TOTAL
                            </th>
                            <th>
                                <center>${{number_format($cont, 0, ",", ".");}}</center>
                            </th>
                        </tr>
                    </tbody>
                </table>
